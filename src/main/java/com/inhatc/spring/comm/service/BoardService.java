...
public class BoardService {
   ...
   public List<ProdVO> showProdService() throws Exception {
	   return mBoardMapper.prodSelectAll();
   }
   
   public String boardDetailCopService(int b_no) throws Exception {
	   return mBoardMapper.boardDetailCop(b_no);
   }
   
   public String boardDetailProdService(int b_no) throws Exception {
	   return mBoardMapper.boardDetailProd(b_no);
   }
}